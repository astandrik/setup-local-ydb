...
async function run() {
    try {
        ...
        await (0, ydb_1.cleanupLocalYdb)(state, new exec_1.CommandRunner());
    }
    catch (error) {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(7167);
